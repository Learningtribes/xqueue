...
class Command(BaseCommand):
    help = """
           Retire submissions for the requested <lt_queue> that were submitted from the LMS before <date>
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            'queue_name',
            help="Which lt_queue to retire submissions for")
    ...
    def handle(self, *args, **options):
        ...
        for submission in submissions:
            log.info("Retiring submission id={} from lt_queue '{}' ".format(submission.id, submission.queue_name))

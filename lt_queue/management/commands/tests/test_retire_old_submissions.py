...
class RetireOldSubmissionsTest(TestCase):
    ...
    @patch('lt_queue.management.commands.retire_old_submissions.post_failure_to_lms', return_value=True)
    ...
    @patch('lt_queue.management.commands.retire_old_submissions.log')
    @patch('lt_queue.management.commands.retire_old_submissions.post_failure_to_lms', return_value=False)
